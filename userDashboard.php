  ...
  <div id="wrapper">
    ...
    <div id="sidebar-wrapper">
      ...
      <ul id="sidebar-nav" >
        ...
        <li><a href="logout.php?status=6"><i class="icons fa fa-sign-out fa-fw"></i> Logout</a></li>
      </ul>
    </div>
          ...
          <div class="col-md-12 ">
						<div class="well">
							<h3>Welcome <?php 
										...
										?></h3>
	            <p>
	              You are in the right place where you can add value to others and get satisfaction at the end of it. Donating or swapping a book with someone will nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
	            </p>
						</div>
					</div>
        </div>
