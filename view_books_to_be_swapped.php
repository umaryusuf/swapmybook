  ...
  <div id="wrapper" >
    ...
    <div id="sidebar-wrapper">
      ...
      <ul id="sidebar-nav" >
        ...
        <li><a href="logout.php?status=2"><i class="icons fa fa-sign-out fa-fw"></i> Logout</a></li>
      </ul>
    </div>
    ...
    <div id="page-content-wrapper">
      <div class="container-fliud">
        <div class="row">
          <div class="col-md-12 ">
						<div class="well">
							<h3>All Books to be swapped/for Donation</h3>
	            <p>
	              Below are the books that are available for swapping or donation. You can click on "Donate a Book" to swap or donate a book to the person who made the request. laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
	            </p>
				<p>
					<?php	
						$result1 = mysql_query("SELECT * FROM donatebook")or die(mysql_error());			
											
												if (mysql_num_rows($result1)> 0){
													echo'<table border="0" cellpadding="4" width="1000">';
														echo'<tr>
														<th width="30%">NAME OF BOOK</th>
													...
													while ($row=mysql_fetch_array($result1)){
														...
														<td width="30%">'.$row['donateBookName'] .'</td>
														<td width="40%">'.$row['donateBookAuthor'] .'</td>
														<td width="30%">'.$row['dateDonated'] .'</td>
														</tr>';
														$i++;
													}
													echo'</div></table>';
